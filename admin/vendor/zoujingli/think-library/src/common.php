...
if (PHP_SAPI !== 'cli') {
    ...
    Middleware::add(function (Request $request, \Closure $next, $header = []) {
        ...
        if (($origin = $request->header('origin', '*')) !== '*') {
            ...
            $header['Access-Control-Allow-Headers'] = 'Authorization,Content-Type,If-Match,If-Modified-Since,If-None-Match,If-Unmodified-Since,X-Requested-With,key,token';

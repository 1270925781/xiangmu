...
CKEDITOR.editorConfig = function (config) {
    ...
    config.toolbar = [
        ...
        {name: 'basicstyles', items: ['Bold', 'Italic', 'Underline', 'Strike', 'RemoveFormat', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock', 'NumberedList', 'BulletedList']},
        {name: 'uimage', items: [ 'UploadImage']},
    ];
